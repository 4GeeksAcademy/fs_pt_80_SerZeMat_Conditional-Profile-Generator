  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class="${
            ...
            <li><a href="https://x.com/ ${
              variables.twitter ? variables.twitter : "4geekacademy"
            }">
...
window.onload = function() {
  window.variables = {
    ...
    background:
      "https://wallpapers.com/images/hd/two-spacex-rockets-gin7eu3y99fv2od0.webp",
    // this is the url for the profile avatar
    avatarURL:
      "https://wallpapers.com/images/high/spacex-starman-93bjvlh9b5sji2ve.webp",
